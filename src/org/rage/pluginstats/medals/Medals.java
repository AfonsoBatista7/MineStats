...
public enum Medals {
	...
	BETA(MLevel.GOD, 2, "Player that played on Beta"),		  												// #2 Beta Player
	...
	PVPMASTER(30, 3, 6, "Kills", "Kill players"),			  												// #6 Players Killed
	MOBSLAYER(5000, 2, 7, "Mob Kills", "Kill mobs"),			  											// #7 Mobs Killed
	WORLDTRAVELLER(500000, 2, 8, "Meters Travelled", "Travel arround the world :D"),		  				// #8 Meters Walked
	TIMETRAVELLER(5, 1.5, 9, "Versions Played", "Play in multiple versions in the server"),		  			// #9 Versions Played				 
	REDSTONENGINEER(64, 6, 10, "Redstone Used", "Use Redstone"),		  									// #10 Redstone Used
	...
	TIMEWALKER(100, 2, 16, "Time Played", "Play some time in the server :DDD"),			  					// #16 Time Played					 
